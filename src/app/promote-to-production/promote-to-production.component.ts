...
export class PromoteToProductionComponent implements OnInit, AfterViewInit, AfterContentChecked {
  ...
  updateRequests() {
    ...
    const dialogRef = this.dialog.open( ConfirmUpdateRequestsDialog, { data: selectedRequestIds } );
  ...
  deleteRequests() {
    ...
    const dialogRef = this.dialog.open( ConfirmRequestsDialog, { data: selectedRequestIds } );
...
@Component({
  selector: 'delete-requests-dialog-prod',
...
@Component({
  selector: 'update-requests-dialog-prod',
  templateUrl: 'update-requests-dialog.html',
  imports: [
    MatButtonModule,
    MatDialogTitle,
    MatDialogContent,
...
export class ConfirmUpdateRequestsDialog implements AfterViewInit{
 
  readonly dialogRef = inject(MatDialogRef<ConfirmUpdateRequestsDialog>);
  readonly data = inject<DialogData>(MAT_DIALOG_DATA);
  readonly confirmSubmit = model( "submit" );
